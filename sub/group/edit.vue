	...
	<view class="page">
		<uni-card>
			<uni-forms ref="form" :modelValue="formData" :rules="rules" :label-width="100">
				...
				<uni-forms-item label="报警电话1" name="cellphone1">
					<uni-easyinput v-model="formData.cellphone1" placeholder="请输入报警电话1" />
				</uni-forms-item>
				
				<uni-forms-item label="报警电话2" name="cellphone2">
					<uni-easyinput v-model="formData.cellphone2" placeholder="请输入报警电话2" />
				</uni-forms-item>
				
				<uni-forms-item label="报警电话3" name="cellphone3">
					<uni-easyinput v-model="formData.cellphone3" placeholder="请输入报警电话3" />
				</uni-forms-item>
			</uni-forms>
		...
		methods: {
			...
			async loadGroupDetail() {
				try {
					...
					this.formData.cellphone1 = data.cellphone1 || '';
					this.formData.cellphone2 = data.cellphone2 || '';
					this.formData.cellphone3 = data.cellphone3 || '';
				} catch (error) {
			...
			async submit() {
				this.$refs.form.validate().then(async (valid) => {
					...
					const submitData = {
						...
						cellphone1: this.formData.cellphone1 || '',
						cellphone2: this.formData.cellphone2 || '',
						cellphone3: this.formData.cellphone3 || ''
					};
