...
export type { AllowedComponentProps, AppPlatform, AutoResize, BuiltInPlatform, CanvasContext, CanvasNode, CanvasRect, ChartOption, ChartOptionInjection, ChartTheme, ChartThemeInjection, CoreEcharts, EChartsType, Emitter, EventHandlerList, EventHandlerMap, EventType, ExtractValue, GetTouchFuc, Handler, InitOptions, InitOptionsInjection, InitParameters, Injection, LoadingOptions, LoadingOptionsInjection, NormalizedTouch, NullableValue, OptionalValue, PublicApi, UpdateOptions, UpdateOptionsInjection, VueThis, WildCardEventHandlerList, WildcardHandler, ZRenderHandler, ZRenderType };
