<template>
  <view class="stats-container">
    ...
    <view class="stats-row">
      <view class="stat-card" v-for="(stat, index) in deviceStats" :key="index">
        ...
        <view class="stat-trend" :class="stat.trend">
          <image class="trend-icon" :src="stat.trendIcon" mode="aspectFit"></image>
        </view>
      </view>
    </view>
    ...
    <view class="bottom-nav">
      ...
      >
        <view class="nav-icon">
          <image class="nav-icon-img" :src="currentPage === nav.page ? nav.activeIcon : nav.icon" mode="aspectFit"></image>
        </view>
      ...
      navigation: [
        {
          ...
          activeIcon: '/static/icon_index/home.png',
        ...
        },
        {
          ...
          activeIcon: '/static/icon_index/map.png',
          url: '/pages/maps/maps'
        },
        {
          text: '关于',
          page: 'about',
          icon: '/static/icon_profile/about.png',
          activeIcon: '/static/icon_profile/about.png',
